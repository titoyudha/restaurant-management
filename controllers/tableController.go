...
var tableCollection *mongo.Collection = databases.OpenCollection(databases.Client, "table")
...
func GetTableByID() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error fetching the table"})
			return
		}
